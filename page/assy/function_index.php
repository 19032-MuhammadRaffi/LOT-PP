...
if (isset($_POST['btn_finish'])) {
    ...
    try {
        ...
        mysqli_commit($conn);
        echo "<script>alert('Finish production sukses');location.href='index.php';</script>";
        exit;
    } catch (Exception $e) {
...
if (isset($_POST['btn_voucher'])) {
    ...
    try {
        ...
        mysqli_commit($conn);
        echo "<script>alert('Voucher berhasil');location.href='index.php';</script>";
        exit;
    } catch (Exception $e) {
        mysqli_rollback($conn);
        echo "<script>alert('ERROR: {$e->getMessage()}');history.back();</script>";
